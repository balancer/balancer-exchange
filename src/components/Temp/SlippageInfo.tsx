...
const SlippageInfo = observer( ({ expectedSlippage, setSlippageSelectorOpen}) => {
	...
	return(
		<SlippageInfoContainer>
			...
			<SlippageInlineDisplay  onClick={() => {setSlippageSelectorOpen(true)}}>{swapFormStore.inputs.slippageAmount}%</SlippageInlineDisplay>
